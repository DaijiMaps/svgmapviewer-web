...
`;function nV(e){return e?"selected":"unselected"}function nX(){return tq("header",(0,w.jsx)(nG,{}),"ui"),(0,w.jsx)("div",{id:"header"})}function nG(){let e=(0,p.useRef)(null);(0,p.useEffect)(()=>{requestAnimationFrame(()=>nD({type:"RENDERED"}))},[]),et(t6,e,"header");let t=v();return(0,w.jsxs)("div",{ref:e,className:"ui-content header",onAnimationEnd:()=>nD({type:"HEADER.ANIMATION.END"}),children:[(0,w.jsx)("h1",{className:"title",onClick:()=>ng(),children:t.title}),(0,w.jsx)(nq,{}),(0,w.jsx)("style",{children:n_})]})}let n_=`
.header {
  ${ei}
  ${eh}
  padding: 0.5em;
