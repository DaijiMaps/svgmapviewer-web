...
`,eX=(i=`${eF} * var(--distance-idx)`,a=`${eH} / 2 + ${i}`,o=`${eP} / 2`,`
.distance-x {
  transform: translate(calc(${a}), calc(${o})) scale(0.5);
}
`),eG=(l=`${eF} * var(--distance-idx)`,s=`${eH} / 2`,c=`${eP} / 2 + ${l}`,`
.distance-y {
...
`;function nZ(){let e=(0,p.useRef)(null),{fidx:t,fidxToOnClick:n}=tF(),r=v();return et(tp,e,"floors"),void 0===r.floorsConfig||r.floorsConfig.floors.length<2?(0,w.jsx)(w.Fragment,{}):(0,w.jsxs)("div",{ref:e,className:"floors",children:[(0,w.jsx)("ul",{className:"floor-list",children:r.floorsConfig.floors.map((e,r)=>{let{name:i}=e;return(0,w.jsx)("li",{className:`floor-item ${nV(r===t)}`,onClick:n(r),children:i},r)})}),(0,w.jsx)("style",{children:nY})]})}let nY=`
.floors {
...
`;function nq(){let{fidx:e}=tF(),t=v().floorsConfig;return void 0===t||t.floors.length<2?(0,w.jsx)(w.Fragment,{}):(0,w.jsxs)("div",{children:[t.floors.map((t,n)=>(0,w.jsx)("h2",{className:`floor-name ${nV(n===e)}`,children:t.name},n)),(0,w.jsx)("style",{children:nB})]})}let nB=`
.floor-name {
  position: absolute;
