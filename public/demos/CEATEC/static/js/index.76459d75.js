...
`})]})}function tw(e){let{_p:t,_hv:n,_size:r,_leg:i}=e,o=tm(),a=null!==t&&null!==n&&tl(o)?function(e,t,n,r){let{open:i,animating:o}=e,{width:a,height:l}=n,s=D(r.q,-1);if(o){let[e,n]=i?[0,1]:[1,0],[r,o]=i?[0,1]:[1,0],[c,d]=i?["0px","0px"]:["var(--dp-x)","var(--dp-y)"],[u,h]=i?["var(--dp-x)","var(--dp-y)"]:["0px","0px"],x=i?eZ:eP;return`
.detail,
.balloon {
  --q-x: ${t.x}px;
  --q-y: ${t.y}px;
...
l 1,2
l 1,-2
`;function nv(){return(0,u.jsx)("div",{className:"button-item zoom-in",onClick:()=>tE(),children:(0,u.jsx)("svg",{viewBox:"-5.25 -5.25 10.5 10.5",children:(0,u.jsx)("path",{d:nw})})})}let nw=`
M0,0
m5,5
l-2,-2
a3,3 0,1,1 -6,-6
...
m-2.5,-2.5
v5
`;function nj(){return(0,u.jsx)("div",{className:"button-item zoom-out",onClick:()=>tS(),children:(0,u.jsx)("svg",{viewBox:"-5.25 -5.25 10.5 10.5",children:(0,u.jsx)("path",{d:nE})})})}let nE=`
M0,0
m5,5
l-2,-2
a3,3 0,1,1 -6,-6
...
m-2.5,0
h5
`;function nS(){return e4("right",(0,u.jsx)(nb,{}),"ui"),(0,u.jsx)("div",{id:"right"})}function nb(){return(0,u.jsxs)("div",{className:"ui-content right bottom",children:[(0,u.jsx)(n$,{}),(0,u.jsx)("style",{children:nO})]})}let nO=`
.right {
  ${eN}
  ${ez}
  padding: 0.4em;
...
`;function nC(){let{open:e,animating:t}=tm(),n=eS(e=>e.animating);if(!t)return e?(0,u.jsx)(u.Fragment,{children:`
.screen {
  opacity: 0.3;
  will-change: opacity;
}
...
`;return(0,u.jsxs)(u.Fragment,{children:[(0,u.jsx)("style",{children:e}),(0,u.jsx)(n3,{}),(0,u.jsx)(n4,{}),(0,u.jsx)(n6,{})]})}function n3(){let e=eS(e=>e.layout.content),t=`
.content {
  ${eM}
  contain: strict;
