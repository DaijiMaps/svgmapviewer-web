...
`;function e4(){let{open:t,animating:e}=eC();if(e){let[e,n]=t?[0,1]:[1,0],r=t?ta:tl;return(0,z.jsx)(z.Fragment,{children:`
.footer {
  --duration: 300ms;
  --timing: ${r};
  --a: ${e};
...
`;return(0,z.jsxs)(z.Fragment,{children:[n,r,i]})}function ni(){let{width:t,height:e}=t6(),{client:n}=t7(),r=`
.distance {
  ${P}
  margin: 0.1em;
  padding: 0;
