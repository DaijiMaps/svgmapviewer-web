(()=>{var e,t,n,r,i={303(e,t,n){var r={"./floor-1F.svg":"901"};function i(e){return n(o(e))}function o(e){if(!n.o(r,e)){var t=Error("Cannot find module '"+e+"'");throw t.code="MODULE_NOT_FOUND",t}return r[e]}i.keys=function(){return Object.keys(r)},i.resolve=o,e.exports=i,i.id=303},901(e,t,n){"use strict";e.exports=n.p+"static/svg/floor-1F.bd363a86.svg"},76(e,t,n){"use strict";let r,i,o;var a,l=n(797);let s={type:"Feature",name:"",crs:{type:"",properties:{name:""}},features:[]};new DOMMatrixReadOnly;let c={root:"root",href:"map.svg",width:0,height:0,fontSize:16,title:"svgmapviewer",subtitle:"svgmapviewer - An (opinionated) interactive offline SVG map viewer",copyright:"@ Daiji Maps",zoomFactor:3,isContainerRendered:()=>!0,isUiRendered:()=>!0,mapData:{areas:s,internals:s,origin:s,measures:s,viewbox:s,points:s,lines:s,multilinestrings:s,multipolygons:s},mapMap:{pointMap:new Map,lineMap:new Map,multilinestringMap:new Map,multipolygonMap:new Map},mapCoord:{matrix:new DOMMatrixReadOnly},origViewBox:{x:0,y:0,width:0,height:0},renderMap:function(){return(0,l.createElement)("div")},isMapRendered:()=>!0,getMapNames:()=>[],getMapPaths:()=>[],getMapObjects:()=>[],getMapSymbols:()=>[],getMapMarkers:()=>[],mapSvgStyle:"",osmSearchEntries:[],getSearchEntries:()=>[],getSearchInfo:()=>null,renderInfo:function(e){return(0,l.createElement)("p",{},e.info.title)}};function d(e){c={...c,...e}}var u=n(617);n(58);var h=n(815),x=n(622);let p=h.Ay$.union([h.Ay$.number(),h.Ay$.string()]),g=h.Ay$.array(p),m=h.Ay$.object({ids:g}),y=x.codec(x.string(),m,{decode:(e,t)=>{try{return JSON.parse(e)}catch(n){return n instanceof x.ZodError&&t.issues.push({code:"invalid_format",format:"json",input:e,message:n.message}),x.NEVER}},encode:e=>JSON.stringify(e)}),f=h.Ay$.union([h.Ay$.number(),h.Ay$.string()]),v=h.Ay$.set(f),w=h.Ay$.object({ids:v}),S=h.Ay$.codec(m,w,{decode:e=>({ids:new Set(e.ids)}),encode:e=>({ids:Array.from(e.ids)})});h.Ay$.pipe(y,S);let j=`
.liked {
  color: orange;
}
...
`})]})}function tw(e){let{_p:t,_hv:n,_size:r,_leg:i}=e,o=tm(),a=null!==t&&null!==n&&tl(o)?function(e,t,n,r){let{open:i,animating:o}=e,{width:a,height:l}=n,s=D(r.q,-1);if(o){let[e,n]=i?[0,1]:[1,0],[r,o]=i?[0,1]:[1,0],[c,d]=i?["0px","0px"]:["var(--dp-x)","var(--dp-y)"],[u,h]=i?["var(--dp-x)","var(--dp-y)"]:["0px","0px"],x=i?eP:eZ;return`
.detail,
.balloon {
  --q-x: ${t.x}px;
  --q-y: ${t.y}px;
...
`}(o,t,r,i):".balloon, .detail { visibility: hidden; }";return(0,u.jsx)("style",{children:a})}let tS={zoomIn:new Set,zoomOut:new Set,rotate:new Set,reset:new Set,recenter:new Set,fullscreen:new Set,position:new Set},tj=()=>ee(tS.zoomIn),tE=()=>ee(tS.zoomOut),tb=()=>ee(tS.rotate),tO=()=>ee(tS.reset),t$=()=>ee(tS.recenter),tM={multiStart:new Set,multiEnd:new Set,zoom:new Set},tN=(0,_.e)("panning");tN.subscribe(e=>{let t;return t=e,et(er.mode,t)});let tA=(0,B.mj)({types:{},guards:{isHoming:e=>{let{context:{animationReq:t}}=e;return null!==t&&"home"===t.type},isContainerRendered:()=>null!==document.querySelector(".container"),isMapRendered:()=>c.isMapRendered(),isUiRendered:()=>c.isUiRendered()},actions:{setRendered:(0,J.a)({rendered:!0}),emitGetScroll:(0,eX.a)(()=>({type:"SCROLL.GET"})),emitSyncScroll:(0,eX.a)(e=>{let{context:{layout:t}}=e;return{type:"SCROLL.SYNC",pos:t.scroll}}),emitSyncScrollSync:(0,eX.a)(e=>{let{context:{layout:t}}=e;return{type:"SCROLL.SYNCSYNC",pos:t.scroll}}),calcZoomAnimation:(0,J.a)({animation:e=>{var t,n,r,i,o,a,l,s,d,u,h;let x,p,g,m,y,f,v,w,{context:{animationReq:S,layout:j}}=e;return null===S?null:"zoom"===S.type?(t=j,n=S.z,r=S.p,x=es(t).inverse().transformPoint(r),p=1/(i=n,Math.pow(c.zoomFactor,i)),g=eo().scale(1/p,1/p),{type:"Zoom",svg:Y(t.svg,p,x.x,x.y),svgScale:t.svgScale*p,q:g,o:r}):"home"===S.type?(o=j,m=R((a=function(e){let{config:t,content:n}=e;return{config:t,...el(t),content:n}}(j)).config.inner),y=es(o).transformPoint(m),f=a.svgScale/o.svgScale,w=(function(e,t){if(e instanceof DOMMatrixReadOnly)return eo(1,0,0,1,e.e,e.f);if("number"==typeof e&&"number"==typeof t)return eo(1,0,0,1,e,t);throw Error("dommatrixreadonlyTranslateOnly")})((v=R(o.container)).x-y.x,v.y-y.y).multiply((l=1/f,s=1/f,d=y.x,u=y.y,eo().scale(l,s,1,d,u,0))),{type:"Zoom",svg:a.svg,svgScale:a.svgScale,q:w,o:null}):(h=S.p,{type:"Rotate",deg:90,q:eo().rotate(90),o:h})}}),updateLayoutFromZoom:(0,J.a)({prevLayout:e=>{let{context:{layout:t}}=e;return t},layout:e=>{let{context:{layout:t,animation:n}}=e;return function(e,t){var n,r,i;return null===t?e:"Move"===t.type?(n=t.move,{...e,scroll:z(e.scroll,n)}):"Zoom"===t.type?(r=t.svg,i=t.svgScale,{...e,svg:r,svgScale:i}):ep(e,t.deg)}(t,n)}}),endZoom:(0,J.a)({prevLayout:null,animation:null,zoom:e=>{let{context:{zoom:t,animationReq:n}}=e;return t*(null===n||"zoom"!==n.type?1:Math.pow(2,n.z))},rotate:e=>{let{context:{rotate:t,animationReq:n}}=e;return t+(null===n||"rotate"!==n.type?0:n.deg)}}),endHome:(0,J.a)({cursor:e=>{let{context:{origLayout:t}}=e;return R(t.container)},layout:e=>{let{context:{origLayout:t,rotate:n}}=e;return ep(eh(t,9),n)}}),emitSyncAnimation:(0,eX.a)(e=>{let{context:{animation:t}}=e;return{type:"SYNC.ANIMATION",animation:t}}),emitZoomStart:(0,eX.a)(e=>{let{context:{layout:t,zoom:n}}=e;return{type:"ZOOM.START",layout:t,zoom:n}}),emitZoomEnd:(0,eX.a)(e=>{let{context:{layout:t,zoom:n}}=e;return{type:"ZOOM.END",layout:t,zoom:n}}),resetCursor:(0,J.a)({cursor:e=>{let{context:{layout:t}}=e;return R(t.container)}}),resizeLayout:(0,J.a)({rendered:!1,origLayout:(e,t)=>{let{layout:n}=t;return n},layout:(e,t)=>{let{layout:n}=t;return eh(n,9)}}),updateLayoutFromScroll:(0,J.a)({layout:e=>{let{context:t}=e,{scroll:n}=ey;return eg(t.layout,n)}}),emitSyncLayout:(0,eX.a)(e=>{let{context:{layout:t,rendered:n}}=e;return{type:"SYNC.LAYOUT",layout:t,force:n}}),emitSearchStart:(0,eX.a)(e=>{let{context:{layout:t,cursor:n}}=e,{scroll:r}=ey;return{type:"SEARCH.START",req:{psvg:es(eg(t,r)).inverse().transformPoint(n)}}}),emitSearchEndDone:(0,eX.a)((e,t)=>{let{context:n}=e,{res:r}=t,{scroll:i}=ey,o=eg(n.layout,i);return{type:"SEARCH.END.DONE",res:null===r?null:{...r,layout:o}}}),emitSwitch:(0,eX.a)((e,t)=>{let{fidx:n}=t;return{type:"SWITCH",fidx:n}}),emitSwitchDone:(0,eX.a)(()=>({type:"SWITCH.DONE"}))}}).createMachine({id:"viewer",initial:"WaitingForResizeRequest",context:{rendered:!1,origLayout:eu,prevLayout:null,layout:eu,cursor:R(eu.container),zoom:1,rotate:0,animationReq:null,animation:null},states:{WaitingForResizeRequest:{on:{RESIZE:{actions:{type:"resizeLayout",params:e=>{let{event:t}=e;return t}},target:"Resizing"}}},Resizing:{initial:"WaitingForMapRendered",onDone:"Idle",states:{WaitingForMapRendered:{after:{250:{target:"WaitingForMapRendered",reenter:!0}},always:{guard:(0,K.j)(["isContainerRendered","isMapRendered","isUiRendered"]),target:"Layouting"}},Layouting:{entry:"emitSyncLayout",on:{RENDERED:{actions:["setRendered","emitSyncLayout","resetCursor"],target:"Syncing"}}},Syncing:{entry:"emitSyncScrollSync",on:{"SCROLL.SYNCSYNC.DONE":{target:"Appearing"}}},Appearing:{on:{"ANIMATION.END":{target:"Done"}}},Done:{type:"final"}}},Idle:{on:{RESIZE:{actions:[{type:"resizeLayout",params:e=>{let{event:t}=e;return t}}],target:"Resizing"},SEARCH:{actions:(0,J.a)({cursor:e=>{let{event:{pos:t}}=e;return t}}),target:"Searching"},SWITCH:{actions:{type:"emitSwitch",params:e=>{let{event:t}=e;return t}},target:"Switching"},RECENTER:{target:"Recentering"},ZOOM:{actions:(0,J.a)({animationReq:e=>{let{context:{layout:t},event:{z:n,p:r}}=e;return{type:"zoom",z:n,p:r??R(t.container)}}}),target:"Zooming"},HOME:{actions:(0,J.a)({animationReq:{type:"home"}}),target:"Zooming"},ROTATE:{actions:(0,J.a)({animationReq:e=>{let{context:{layout:t}}=e;return{type:"rotate",deg:90,p:R(t.container)}}}),target:"Zooming"}}},Searching:{initial:"Starting",onDone:"Idle",states:{Starting:{always:{actions:"emitSearchStart",target:"WaitingForSearchEnd"}},WaitingForSearchEnd:{on:{"SEARCH.END":{actions:{type:"emitSearchEndDone",params:e=>{let{event:t}=e;return t}},target:"WaitingForSearchDone"}}},WaitingForSearchDone:{on:{"SEARCH.DONE":{target:"Done"}}},Done:{type:"final"}}},Switching:{initial:"Animating",onDone:"Idle",states:{Animating:{on:{"SWITCH.DONE":{actions:{type:"emitSwitchDone"},target:"Done"}}},Done:{type:"final"}}},Recentering:{initial:"Stopping",onDone:"Idle",states:{Stopping:{entry:"emitGetScroll",on:{"SCROLL.GET.DONE":{target:"Rendering"}}},Rendering:{after:{50:{target:"Layouting"}}},Layouting:{always:{actions:["updateLayoutFromScroll","emitSyncLayout","emitSyncScroll"],target:"Done"}},Done:{type:"final"}}},Zooming:{id:"Zooming",initial:"Stopping",onDone:"Idle",states:{Stopping:{entry:"emitGetScroll",on:{"SCROLL.GET.DONE":{target:"Rendering"}}},Rendering:{after:{50:{target:"Starting"}}},Starting:{always:{actions:["updateLayoutFromScroll","calcZoomAnimation","updateLayoutFromZoom","emitZoomStart","emitSyncAnimation"],target:"Ending"}},Ending:{on:{"ANIMATION.END":{actions:["endZoom","emitSyncLayout","emitSyncScroll","emitZoomEnd","emitSyncAnimation"],target:"Homing"}}},Homing:{always:[{guard:"isHoming",actions:["endHome","emitSyncLayout","emitSyncScroll"],target:"Done"},{target:"Done"}]},Done:{entry:(0,J.a)({animationReq:null}),type:"final"}}}}}),tk=(0,K.c)(tA,{systemId:"system-viewer1"});function tD(e){tk.send(e)}tk.on("SEARCH.START",e=>{let t,{req:n}=e;return t=n,et(ts.start,t)}),tk.on("SEARCH.END.DONE",e=>{let t,n,{res:r}=e;null===r?tk.send({type:"SEARCH.DONE"}):(t=r,et(ts.endDone,t),n=r.psvg,et(tc.open,n))}),tk.on("ZOOM.START",e=>{let t;return t=e,et(er.zoomStart,t)}),tk.on("ZOOM.END",e=>{let t;return t=e,et(er.zoomEnd,t)}),tk.on("SWITCH",e=>{let t,{fidx:n}=e;return t=n,et(eV.select,t)}),tk.on("SWITCH.DONE",()=>ee(eV.unlock)),tk.on("SYNC.ANIMATION",e=>{let t,{animation:n}=e,r=(null==n?void 0:n.q)??null,i=(null==n?void 0:n.o)??null;null!==r&&(t={matrix:r,origin:i},et(er.animation,t))}),tk.on("SYNC.LAYOUT",e=>{let t,{layout:n,force:r}=e;return t={layout:n,force:r},et(er.layout,t)}),tk.on("SCROLL.SYNC",e=>{let t,{pos:n}=e;return t=n,et(en.sync,t)}),tk.on("SCROLL.SYNCSYNC",e=>{let t,{pos:n}=e;return t=n,et(en.syncSync,t)}),tk.on("SCROLL.GET",()=>ee(en.get));let tT=!1,tL=!1;function tC(e){tT="locked"===e,tL="locked"===e}function tR(){let e=(0,l.useRef)(null);return(0,l.useEffect)(()=>{let t=e.current;if(t)return t.addEventListener("wheel",tI),()=>{t.removeEventListener("wheel",tI)}},[e]),e}function tI(e){let t=e.currentTarget;tL&&t instanceof HTMLDivElement&&t.scrollWidth===t.clientWidth&&t.scrollHeight===t.clientHeight&&e.preventDefault()}function tz(e){let t,{_detail:n}=e,r=tR();return(0,u.jsxs)("div",{ref:r,className:"detail",onAnimationEnd:()=>{var e;return e={type:"DETAIL.ANIMATION.END"},void tx.send(e)},children:[c.renderInfo&&(1!==(t=Object.values(n.info)).length||"string"!=typeof t[0]||""!==t[0])&&c.renderInfo({info:n.info}),(0,u.jsx)("style",{children:tF})]})}let tF=`
.detail {
  ${eM}
  width: 50vmin;
  height: 50vmin;
...
`;function tH(){return e4("detail",(0,u.jsx)(tU,{}),"ui"),(0,u.jsx)("div",{id:"detail"})}function tU(){return(0,u.jsxs)("div",{className:"ui-content detail-balloon",children:[(0,u.jsx)(tW,{}),(0,u.jsx)(tq,{})]})}function tW(){let e,t,n,r,i,o,a,l,s,c,d,h,x=tp().detail,p=(o=x.p,a=x.layout,l=function(e,t){let{x:n,y:r}=t,i=e.width/e.height,o={x:n/e.width,y:r/e.height},a=i>1?e9(o.x):te(o.x);return{h:a,v:i>1?te(o.y):e9(o.y),th:Math.atan2(e.height,e.width)}}(x.layout.container,o),s=a.container.width,t=50*(e=.01*Math.min(s,c=a.container.height)),n=50*e,r=10*e,i=t/100,h=tt(l,(d={bw:t,bh:n,lh:r,d:i,width:t+2*r+2*i,height:n+2*r+2*i}).bw,d.bh,d.lh),{_p:o,_hv:l,_W:s,_H:c,_size:d,_leg:h});return(0,u.jsxs)(u.Fragment,{children:[(0,u.jsx)(ty,{...p}),(0,u.jsx)(tz,{_detail:x}),(0,u.jsx)(tw,{...p})]})}function tq(){return(0,u.jsx)("svg",{id:"ui-svg-defs",children:(0,u.jsx)("defs",{children:(0,u.jsx)(e7,{})})})}function tP(){return e4("footer",(0,u.jsx)(tZ,{}),"ui"),(0,u.jsx)("div",{id:"footer"})}function tZ(){let e=c;return(0,u.jsxs)("div",{className:"ui-content footer",children:[(0,u.jsx)("p",{children:e.copyright}),(0,u.jsxs)("style",{children:[tY,(0,u.jsx)(tV,{})]})]})}let tY=`
.footer {
  ${eA}
  ${eI}
  padding: 0.4em;
...
`;function tV(){let{open:e,animating:t}=tg();if(t){let[t,n]=e?[0,1]:[1,0],r=e?eP:eZ;return(0,u.jsx)(u.Fragment,{children:`
.footer {
  --duration: 300ms;
  --timing: ${r};
  --a: ${t};
...
`})}function tX(){return(0,u.jsx)(u.Fragment,{children:(0,u.jsx)("g",{id:"measure",children:(0,u.jsx)(tB,{})})})}function tG(){let{svg:e}=e$();return(0,u.jsxs)("div",{id:"distance",children:[(0,u.jsx)("p",{id:"distance-origin",className:"distance",children:"0m"}),t0.map(t=>(0,u.jsxs)(l.Fragment,{children:[(0,u.jsxs)("p",{id:`distance-x-${t+1}`,className:"distance distance-x",children:[e*(t+1),"m"]}),(0,u.jsxs)("p",{id:`distance-y-${t+1}`,className:"distance distance-y",children:[e*(t+1),"m"]})]},t)),(0,u.jsx)("style",{children:(0,u.jsx)(tQ,{})})]})}function t_(){let e=eE(e=>e.geoPoint),t=e.x>0?"E":"W",n=e.y>0?"N":"S",r=`${t} ${X(Math.abs(e.x))}`,i=`${n} ${X(Math.abs(e.y))}`;return(0,u.jsxs)("div",{id:"coordinate",children:[(0,u.jsx)("p",{id:"longitude",children:r}),(0,u.jsx)("p",{id:"latitude",children:i}),(0,u.jsx)("style",{children:(0,u.jsx)(tK,{})})]})}function tB(){let{width:e,height:t}=eO(),{client:n}=e$(),r=(0,l.useMemo)(()=>`M0,${t/2} h${e}`,[t,e]),i=(0,l.useMemo)(()=>`M${e/2},0 v${t}`,[t,e]),o=(0,l.useMemo)(()=>t0.map(r=>(function(e){let{width:t,height:n,r}=e;return`M${t/2},${n/2} m-${r},0 a${r},${r} 0,1,0 ${2*r},0 a${r},${r} 0,1,0 -${2*r},0`.replaceAll(/([.]\d)\d*/g,"$1")})({width:e,height:t,r:n*(r+1)})),[n,t,e]);return(0,u.jsxs)(u.Fragment,{children:[(0,u.jsx)("path",{id:"measure-horizontal",className:"measure-line",stroke:"black",strokeWidth:"0.1px",fill:"none",d:r}),(0,u.jsx)("path",{id:"measure-vertical",className:"measure-line",stroke:"black",strokeWidth:"0.1px",fill:"none",d:i}),o.map((e,t)=>(0,u.jsx)("path",{id:`measure-ring-${t+1}`,className:"measure-line",stroke:"black",strokeWidth:"0.1px",fill:"none",d:e},t))]})}function tJ(){let{open:e,animating:t}=tg(),[n,r]=e?[0,1]:[1,0],i=t?`
.guides {
  --timing: ${e?eP:eZ};
  --duration: 300ms;
  --oa: ${n};
...
`;function t6(){let{fidx:e}=e1(),t=c.floorsConfig;return void 0===t||t.floors.length<2?(0,u.jsx)(u.Fragment,{}):(0,u.jsxs)("div",{children:[t.floors.map((t,n)=>(0,u.jsx)("h2",{className:`floor-name ${t8(n===e)}`,children:t.name},n)),(0,u.jsx)("style",{children:t7})]})}let t7=`
.floor-name {
  position: absolute;
...
`;function nn(){let{open:e,animating:t}=tg();if(t){let[t,n]=e?[0,1]:[1,0],r=e?eP:eZ;return(0,u.jsx)(u.Fragment,{children:`
.header {
  --timing: ${r};
  --duration: 300ms;
  --a: ${t};
...
`;function na(){let{open:e,animating:t}=tg();if(t){let[t,n]=e?[0,1]:[1,0],r=e?eP:eZ;return(0,u.jsx)(u.Fragment,{children:`
.left {
  --timing: ${r};
  --duration: 300ms;
  --a: ${t};
...
`})}function nl(){return(0,u.jsx)("div",{className:"button-item fullscreen",onClick:()=>ee(tS.fullscreen),children:(0,u.jsx)("svg",{viewBox:"-5.25 -5.25 10.5 10.5",children:(0,u.jsx)("path",{d:ns})})})}let ns=`
M0,0
m5,5
m-1,-1
h-8
...
l-6,0
l0,-5
`;function nu(){return c.mapCoord.matrix.isIdentity?(0,u.jsx)(u.Fragment,{}):(0,u.jsx)("div",{className:"button-item position",onClick:()=>ee(tS.position),children:(0,u.jsx)("svg",{viewBox:"-5.25 -5.25 10.5 10.5",children:(0,u.jsx)("path",{d:np})})})}let nh=3*Math.sqrt(2),nx=nh+6,np=`
M 0,0
m 0,${nx/2}
l -3,-3
a ${nh},${nh} 0,1,1 6,0
...
a ${nh/2},${nh/2} 0,1,0 0,${nh}
`.replaceAll(/([.]\d\d)\d*/g,"$1");function ng(){return(0,u.jsx)("div",{className:"button-item recenter",onClick:()=>t$(),children:(0,u.jsx)("svg",{viewBox:"-5.25 -5.25 10.5 10.5",children:(0,u.jsx)("path",{d:nm})})})}let nm=`
M0,5
V-5
M5,0
H-5
...
l1,-2
l1,2
`;function ny(){return(0,u.jsx)("div",{className:"button-item rotate",onClick:()=>tb(),children:(0,u.jsx)("svg",{viewBox:"-5.25 -5.25 10.5 10.5",children:(0,u.jsx)("path",{d:nf})})})}let nf=`
M -4,-4
l 2,0
a 6,6 0,0,1 6,6
l 0,2
...
l 1,2
l 1,-2
`;function nv(){return(0,u.jsx)("div",{className:"button-item zoom-in",onClick:()=>tj(),children:(0,u.jsx)("svg",{viewBox:"-5.25 -5.25 10.5 10.5",children:(0,u.jsx)("path",{d:nw})})})}let nw=`
M0,0
m5,5
l-2,-2
a3,3 0,1,1 -6,-6
...
m-2.5,-2.5
v5
`;function nS(){return(0,u.jsx)("div",{className:"button-item zoom-out",onClick:()=>tE(),children:(0,u.jsx)("svg",{viewBox:"-5.25 -5.25 10.5 10.5",children:(0,u.jsx)("path",{d:nj})})})}let nj=`
M0,0
m5,5
l-2,-2
a3,3 0,1,1 -6,-6
...
`;function n$(){return(0,u.jsxs)("div",{className:"button",children:[(0,u.jsx)(nu,{}),(0,u.jsx)(nc,{}),(0,u.jsx)(nl,{}),(0,u.jsx)(ng,{}),(0,u.jsx)(ny,{}),(0,u.jsx)(nS,{}),(0,u.jsx)(nv,{}),(0,u.jsxs)("style",{children:[nM,(0,u.jsx)(nN,{})]})]})}let nM=`
.button {
  font-size: large;
  margin: 0;
  ${eI}
...
`})}function nA(){return e4("screen",(0,u.jsx)(nk,{}),"ui"),(0,u.jsx)("div",{id:"screen"})}function nk(){let e=tR();return(0,u.jsx)("div",{ref:e,className:"ui-content screen",onClick:()=>ee(tc.close),children:(0,u.jsxs)("style",{children:[nD,(0,u.jsx)(nT,{})]})})}let nD=`
.screen {
  ${eM}
  ${eR}
...
`}):n?(0,u.jsx)(u.Fragment,{children:".screen { display: initial; opacity: 0; }"}):(0,u.jsx)(u.Fragment,{children:".screen { display: none; }"});{let[t,n]=e?[0,.3]:[.3,0],r=e?eP:eZ;return(0,u.jsx)(u.Fragment,{children:`
.screen {
  --duration: 400ms;
  --timing: ${r};
  --a: ${t};
...
`})}}function nL(){return e4("ui",(0,u.jsx)(nC,{})),(0,u.jsx)("div",{id:"ui"})}function nC(){return(0,u.jsxs)("div",{className:"ui",children:[(0,u.jsx)(nA,{}),(0,u.jsx)(t9,{}),(0,u.jsx)(tP,{}),(0,u.jsx)(nr,{}),(0,u.jsx)(nE,{}),(0,u.jsx)(t1,{}),(0,u.jsx)(tH,{})]})}function nR(){var e,t,n;let r;return null!==(r=(null==(n=document.querySelector("#ui"))||null==(t=n.shadowRoot)||null==(e=t.children)?void 0:e.length)??null)&&r>0}function nI(){t$()}var nz=n(469),nF=n(336),nH=n(5);let nU=nz.OZ(A),nW=nF.aU(N._k),nq=nF.tf(),nP=nF.JI(N.Eq,nz.CA());function nZ(e){return(0,E.Fs)(e,nF.zu(nU),nz.x1(e=>0===e.length?nH.dv:nH.zN(e[0])))}function nY(e){let t;return e.length<2||null===(t=0===e.length?null:e.reduce((e,t)=>({x:e.x+t.x,y:e.y+t.y})))?null:D(t,1/e.length)}function nV(e){return new Map((0,E.Fs)(e.changedTouches,Array.from,nz.Tj(e=>[e.identifier,[{x:e.clientX,y:e.clientY}]])))}let nX=(0,B.mj)({types:{context:{},events:{},emitted:{},tags:{}},guards:{isAllEnding:e=>{let{context:{touches:t}}=e;return 0===t.vecs.size},isSingleTouching:e=>{let{context:{touches:t}}=e;return 1===t.vecs.size},isDoubleTouching:e=>{let{context:{touches:t}}=e;return 2===t.vecs.size},isManyTouching:e=>{let{context:{touches:t}}=e;return t.vecs.size>2},isZooming:e=>{let{context:{touches:t}}=e;return null!==t.z},isModeIdle:e=>{let{context:{mode:t}}=e;return"idle"===t},isModePanning:e=>{let{context:{mode:t}}=e;return"pan"===t},isModePinching:e=>{let{context:{mode:t}}=e;return"pinch"===t}},actions:{updateTouches:(0,J.a)({touches:e=>{var t;let n,r,i,a,l,s,c,d,u,{context:{touches:h},event:x}=e;return"TOUCH.START"===x.type?(t=x.ev,i=nY(r=nZ(n=nP.concat(h.vecs,nV(t)))),l=2!==r.length?null:.5>Math.abs((a=M(r[0],r[1])).y/a.x),{...h,vecs:n,points:r,cursor:i,horizontal:l}):"TOUCH.MOVE"===x.type?function(e,t){var n,r,i,a;let l,s=nV(t),c=nW.mapWithIndex(e.vecs,(e,t)=>(0,E.Fs)(s.get(e),nH.k$,nH.AU(()=>t,nz.xW(t)))),d=nZ(c),u=nY(d),[h,x]=d;if(null===u||h===o||x===o)return{...e,vecs:c,points:d,cursor:u};let p=(n=e.dists,r=Math.sqrt((i=h,a=x,Math.pow(i.x-a.x,2)+Math.pow(i.y-a.y,2))),l=Math.pow((n.length>0?n[0]:r)-r,2),0===n.length||l>0?[r,...n]:n),g=function(e){let[t,n,r,i]=e;return t===o||n===o||r===o||i===o?null:t<n&&n<r&&r<i?-1:t>n&&n>r&&r>i?1:null}(p);return{vecs:c,points:d,cursor:u,dists:p,z:g,horizontal:e.horizontal}}(h,x.ev):"TOUCH.END"===x.type?(s=nV(x.ev),u=nY(d=nZ(c=nq.filterMapWithIndex(h.vecs,(e,t)=>s.has(e)?nH.dv:nH.zN(t)))),{vecs:c,points:d,cursor:u,dists:0===c.size?[]:h.dists,z:0===c.size?null:h.z,horizontal:h.horizontal}):h}}),raiseOp:(0,K.r)(e=>{let{event:t}=e;return"TOUCH.START"===t.type?{type:"STARTED"}:"TOUCH.MOVE"===t.type?{type:"MOVED"}:"TOUCH.END"===t.type?{type:"ENDED"}:{type:"NONE"}}),resetTouches:(0,J.a)({touches:()=>({vecs:new Map,points:[],cursor:null,dists:[],z:null,horizontal:null}),mode:"idle"}),enterPan:(0,J.a)({mode:"pan"}),enterPinch:(0,J.a)({mode:"pinch"}),emitMulti:(0,eX.a)(e=>{let{context:{touches:t}}=e;return{type:"MULTI",touches:t}}),emitZoom:(0,eX.a)(e=>{let{context:{touches:t}}=e;return{type:"ZOOM",touches:t}})}}).createMachine({id:"touch1",initial:"Idle",context:{touches:{vecs:new Map,points:[],cursor:null,dists:[],z:null,horizontal:null},mode:"idle"},on:{"TOUCH.START":{actions:["updateTouches","raiseOp"]},"TOUCH.MOVE":{actions:["updateTouches","raiseOp"]},"TOUCH.END":{actions:["updateTouches","raiseOp"]},CANCEL:{target:".Canceling"}},states:{Idle:{tags:"none",entry:"resetTouches",on:{STARTED:[{guard:"isSingleTouching",target:"SingleTouching"},{guard:"isDoubleTouching",target:"DoubleTouching"},{guard:"isManyTouching",target:"ManyTouching"}]}},SingleTouching:{tags:"single",on:{STARTED:[{guard:(0,K.j)(["isModeIdle","isDoubleTouching"]),actions:"enterPinch",target:"DoubleTouching"},{guard:"isManyTouching",target:"ManyTouching"}],MOVED:{guard:"isModeIdle",actions:"enterPan"},ENDED:[{guard:"isAllEnding",target:"Idle"}]}},DoubleTouching:{tags:"double",entry:"emitMulti",exit:"emitMulti",on:{STARTED:[{guard:(0,K.j)(["isManyTouching"]),target:"ManyTouching"}],MOVED:{guard:(0,K.j)(["isModePinching","isZooming"]),actions:"emitZoom"},ENDED:[{guard:"isAllEnding",target:"Idle"},{guard:"isSingleTouching",target:"SingleTouching"}]}},ManyTouching:{tags:"many",on:{ENDED:[{guard:"isAllEnding",target:"Idle"},{guard:"isSingleTouching",target:"SingleTouching"},{guard:"isDoubleTouching",target:"DoubleTouching"}]}},Canceling:{tags:"cancel",on:{ENDED:[{target:"Idle"}]}}}}),nG=(0,K.c)(nX),n_=!1;function nB(e){nG.send({type:"TOUCH.START",ev:e})}function nJ(e){nG.send({type:"TOUCH.MOVE",ev:e})}function nK(e){nG.send({type:"TOUCH.END",ev:e})}function nQ(){nG.send({type:"CANCEL"})}function n0(e){tT||tD({type:"SEARCH",pos:{x:e.pageX,y:e.pageY}})}function n1(e){let t;null!==e&&(t=e,et(en.eventTick,t))}function n5(e){return(0,u.jsxs)("div",{id:"viewer",className:"container",onTouchStart:nB,onTouchMove:nJ,onTouchEnd:nK,onClick:n0,onContextMenu:nI,onScroll:n1,onAnimationEnd:e=>{var t;(t={type:"ANIMATION.END",ev:e}).ev.stopPropagation(),tD(t),ee(er.animationEnd)},children:[e.children,(0,u.jsx)(n2,{})]})}function n2(){let e=`
.container {
  ${eM}
  ${eR}
...
${j}
`,rw=function(){var e;let t=(null==(e=c.cartoConfig)?void 0:e.backgroundColor)??c.backgroundColor??"darkgray",n={data:c,render:c,carto:c.cartoConfig,floors:c.floorsConfig};return(0,u.jsxs)(u.Fragment,{children:[(0,u.jsx)(n5,{...n,children:c.renderMap(n)}),(0,u.jsx)(nL,{}),(0,u.jsxs)("style",{children:[rv,`body { background-color: ${t}; }`]})]})};function rS(e){let{origViewBox:t,url:n}=e;return(0,u.jsx)("image",{href:n,x:t.x,y:t.y,width:t.width,height:t.height})}function rj(e){let{origViewBox:t,url:n,labels:r}=e;return void 0===r?(0,u.jsx)(u.Fragment,{}):(0,u.jsxs)("svg",{href:n,x:t.x,y:t.y,width:t.width,height:t.height,viewBox:F(t),children:[(0,u.jsx)("style",{children:`
text, tspan {
  font-family: 'Noto Sans JP', 'Noto Sans', 'sans-serif' !important;
  font-weight: 200 !important;
}
`}),r.map((e,t)=>(0,u.jsxs)("text",{...rO(e.attrs),children:["id"in e.attrs&&"style"in e.attrs&&(0,u.jsx)("style",{children:`#${e.attrs.id} { ${e.attrs.style}; }`}),e.children&&e.children.map((e,t)=>(0,u.jsx)("tspan",{...rO(e.attrs),children:e.text??""},t))]},t))]})}let rE=/^[{].*$/,rb=/^style$/;function rO(e){return Object.fromEntries(Object.entries(e).filter(e=>{let[t]=e;return!t.match(rE)&&!t.match(rb)}).map(e=>{var t;let[n,r]=e;return[!(t=n).match(/^.*-.*$/)||t.match(/^(aria|data)-.*$/)?t:t.split("-").map((e,t)=>{var n;let r;return 0===t?e:(r=(n=e).match(/^(.)(.*)$/))?`${r[1].toUpperCase()}${r[2]}`:n}).join(""),r]}))}var r$=JSON.parse('{"1F":{"contentId":"g2527"}}');let rM={},rN=Object.keys(r$).map(e=>({name:e,href:n(303)(`./floor-${e}.svg`),labels:(null==rM?void 0:rM[e])??void 0})),rA=Object.values(JSON.parse('{"1F":{"A1F-Content-(ViewBox)":{"x":0,"y":0},"A1F-Shops-1-1":{"x":90.556,"y":1482.963},"A1F-Shops-1-2":{"x":248.793,"y":1482.395},"A1F-Shops-1-3":{"x":183.567,"y":1393.274},"A1F-Shops-1-4":{"x":103.285,"y":1297.355},"A1F-Shops-1-5":{"x":190.709,"y":1297.354},"A1F-Shops-1-6":{"x":103.285,"y":1244.149},"A1F-Shops-1-7":{"x":103.285,"y":1208.752},"A1F-Shops-1-8":{"x":190.709,"y":1118.305},"A1F-Shops-1-9":{"x":103.285,"y":1100.551},"A1F-Shops-1-10":{"x":103.285,"y":1065.153},"A1F-Shops-1-11":{"x":190.709,"y":1047.401},"A1F-Shops-1-12":{"x":103.285,"y":1029.701},"A1F-Shops-1-13":{"x":103.284,"y":939.406},"A1F-Shops-1-14":{"x":190.71,"y":939.406},"A1F-Shops-1-15":{"x":103.284,"y":868.558},"A1F-Shops-1-16":{"x":103.284,"y":756.529},"A1F-Shops-1-17":{"x":172.631,"y":756.583},"A1F-Shops-1-18":{"x":103.284,"y":559.912},"A1F-Shops-1-19":{"x":172.631,"y":559.912},"A1F-Shops-1-20":{"x":103.284,"y":524.535},"A1F-Shops-1-21":{"x":172.631,"y":506.839},"A1F-Shops-1-22":{"x":103.284,"y":489.083},"A1F-Shops-1-23":{"x":103.284,"y":407.392},"A1F-Shops-1-24":{"x":172.63,"y":407.336},"A1F-Shops-1-25":{"x":103.284,"y":354.164},"A1F-Shops-1-26":{"x":103.284,"y":318.767},"A1F-Shops-1-27":{"x":136.604,"y":253.807},"A1F-Shops-1-28":{"x":172.684,"y":253.807}}}')).concat().flatMap((e,t)=>Object.entries(e).map(e=>{let[n,r]=e;return[n,{coord:r,fidx:t}]}));function rk(e){let[t,n]=e;return n.map(e=>[t,e])}function rD(e){return e.reduce(function(e,t){let[n,r]=t,i=new Set([...e.get(n)??new Set,r]);return new Map([...e,[n,i]])},new Map)}let rT=Object.values(JSON.parse('{"1F":{"マーケティング アソシエーション":["A1F-Shops-1-3"],"ラクーン フィナンシャル":["A1F-Shops-1-4"],"インターファクトリー":["A1F-Shops-1-5"],"ニューワールド カンパニー":["A1F-Shops-1-6"],"Zen Group":["A1F-Shops-1-7"],"アグザルファ":["A1F-Shops-1-8"],"INFLU":["A1F-Shops-1-9"],"ペライチ":["A1F-Shops-1-10"],"Jellyfish Commerce":["A1F-Shops-1-12"],"ジーニー":["A1F-Shops-1-11"]}}')).flatMap(function(e){return Object.entries(e)});rD(Array.from(rT).flatMap(rk));let rL=rD(Array.from(rT).flatMap(rk).map(e=>{let[t,n]=e;return[n,t]}));var rC=JSON.parse('{"x":0,"y":0,"width":2245.04,"height":1587.4}');!function(e){let t;eG.init.add(e=>{if(e.floorsConfig){let t=e.floorsConfig.floors.length,n=e.floorsConfig.initialFidx;eQ.send({type:"INIT",nfloors:t,fidx:n}),e0.postMessage({type:"INIT",cfg:e.floorsConfig})}}),eV.select.add(e=>eQ.send({type:"SELECT",fidx:e})),eV.levelUp.add(()=>eQ.send({type:"LEVEL.UP"})),eV.levelDown.add(()=>eQ.send({type:"LEVEL.DOWN"})),eV.selectDone.add(e=>eQ.send({type:"SELECT.DONE",fidx:e})),tS.fullscreen.add(rf),eG.init.add(ry),tS.position.add(()=>{var e;return e={type:"GET"},void rt.send(e)}),en.eventTick.add(ef),en.eventTick.add(rg.tick),en.get.add(()=>rp({type:"GET"})),en.sync.add(e=>rp({type:"SYNC",pos:e})),en.syncSync.add(e=>rp({type:"SYNCSYNC",pos:e})),eG.init.add(e=>{if(e.getSearchEntries){let t=e.getSearchEntries(e);ro.postMessage({type:"INIT",entries:t})}}),ts.start.add(function(e){rr.send({type:"SEARCH",req:e})}),er.layout.add(function(e){let{layout:t,force:n}=e;ej({type:"STYLE.LAYOUT",layout:t,rendered:n}),requestAnimationFrame(()=>eb())}),er.zoomStart.add(function(e){ej({type:"STYLE.ZOOM",...e})}),er.zoomEnd.add(function(e){ej({type:"STYLE.ZOOM",zoom:e.zoom})}),er.animation.add(function(e){ej({type:"STYLE.ANIMATION",animation:e})}),er.animationEnd.add(function(){ej({type:"STYLE.ANIMATION.END"})}),er.mode.add(function(e){ej({type:"STYLE.MODE",mode:e})}),en.eventExpire.add(eb),tS.reset.add(nQ),tS.fullscreen.add(nQ),tS.position.add(nQ),tS.recenter.add(nQ),tS.zoomOut.add(nQ),tS.zoomIn.add(nQ),ts.endDone.add(e=>tx.send({type:"DETAIL",...e})),tc.open.add(()=>{let e;return e=!0,et(tc.openDone,e)}),tc.openDone.add(e=>tx.send({type:e?"OPEN":"CANCEL"})),tc.close.add(()=>tx.send({type:"CANCEL"})),tc.closeDone.add(()=>{requestAnimationFrame(()=>{var e,t;null==(t=e3.get("detail"))||null==(e=t.querySelector(".detail"))||e.scroll(0,0)})}),eV.lock.add(e=>tD({type:"SWITCH",fidx:e})),eV.selectDone.add(()=>tD({type:"SWITCH.DONE"})),ts.end.add(e=>tk.send({type:"SEARCH.END",res:e})),tc.open.add(()=>tN.set("locked")),tc.closeDone.add(()=>tD({type:"SEARCH.DONE"})),tc.closeDone.add(()=>tN.set("panning")),en.getDone.add(e=>{null!==e&&tD({type:"SCROLL.GET.DONE",scroll:e})}),en.syncSyncDone.add(e=>{null!==e&&tD({type:"SCROLL.SYNCSYNC.DONE",scroll:e})}),er.resize.add(e=>{let{layout:t,force:n}=e;return tD({type:"RESIZE",layout:t,force:n})}),er.mode.add(tC),er.zoomStart.add(()=>{tL=!0}),er.zoomEnd.add(()=>{tL=!1}),tS.reset.add(()=>tD({type:"HOME"})),tS.recenter.add(()=>tD({type:"RECENTER"})),tS.rotate.add(()=>tD({type:"ROTATE"})),tS.zoomOut.add(()=>tD({type:"ZOOM",z:-1,p:null})),tS.zoomIn.add(()=>tD({type:"ZOOM",z:1,p:null})),tM.multiStart.add(()=>ee(en.get)),tM.multiStart.add(()=>tN.set("touching")),tM.multiEnd.add(()=>tN.set("panning")),tM.zoom.add(e=>{let{z:t,p:n}=e;return tD({type:"ZOOM",z:t>0?1:-1,p:n})}),eG.rendered.add(()=>tD({type:"RENDERED"})),eQ.start(),rs.start(),rt.start(),rd.start(),rx.start(),rr.start(),eS.start(),nG.start(),tx.start(),tk.start();let n=(d({origViewBox:t={x:0,y:0,width:"number"==typeof e.width?e.width:0,height:"number"==typeof e.height?e.height:0},isContainerRendered:n7,isUiRendered:nR,...e}),d({...c}),{...c,origViewBox:t,...e});e_(n),console.group(),console.log("Welcome to svgmapviewer!"),console.log("Version:","0.2.0"),console.log("GitHub:","https://github.com/DaijiMaps/svgmapviewer"),console.groupEnd();let r=document.getElementById(n.root);if(null===r)throw Error("#root not found!");r.onwheel=function(e){var t;let n=r.children[0];e.target instanceof HTMLDivElement&&(null==(t=e.target)?void 0:t.id)==="ui"||(null!==n&&n.clientWidth===n.scrollWidth||tL)&&e.preventDefault()},r.oncontextmenu=function(e){e.preventDefault()},r.ontouchmove=function(e){if(tL){var t;if(e.target instanceof HTMLDivElement&&(null==(t=e.target)?void 0:t.id)==="ui")return;e.preventDefault()}else if(!n_)return;e.preventDefault()},document.title=n.title,document.body.onkeydown=e=>{var t;return t={type:"DOWN",key:e.key},void rs.send(t)},document.body.onkeyup=e=>{var t;return t={type:"UP",key:e.key},void rs.send(t)},(0,e5.createRoot)(r).render((0,u.jsx)(l.StrictMode,{children:(0,u.jsx)(rw,{})}));let i=document.getElementById("style-root");if(null===i)throw Error("#style-root not found!");(0,e5.createRoot)(i).render((0,u.jsx)(l.StrictMode,{children:(0,u.jsx)(e2,{})}))}({renderMap:function(e){let{floors:t,data:{origViewBox:n}}=e,{viewBox:r,width:i,height:o}=function(){let{scroll:e,svg:t}=eE(e=>e.layout);return{viewBox:F(t),width:V(e.width),height:V(e.height)}}(),{fidxToOnAnimationEnd:a,urls:s}=e1();return void 0===t?(0,u.jsx)(u.Fragment,{}):(0,u.jsx)("div",{className:"content",children:(0,u.jsx)("svg",{id:"map-svg-floors",className:"content-svg",viewBox:r,width:i,height:o,children:t.floors.map((e,t)=>(0,u.jsx)(l.Fragment,{children:(0,u.jsxs)("g",{className:`floor fidx-${t}`,onAnimationEnd:a(t),children:[(0,u.jsx)(rS,{origViewBox:n,idx:t,url:s.get(t),onAnimationEnd:a(t),labels:e.labels}),(0,u.jsx)(rj,{origViewBox:n,idx:t,url:s.get(t),onAnimationEnd:a(t),labels:e.labels})]})},t))})})},isMapRendered:function(){return!0},...{root:"root",title:"DXPO 2024",backgroundColor:"white",origViewBox:JSON.parse('{"x":0,"y":0,"width":2245.04,"height":1587.4}'),origBoundingBox:rC,zoomFactor:2,floorsConfig:{floors:rN,initialFidx:0},...{getSearchEntries:function(){return rA.map(e=>{let[t,n]=e;return{address:t,pos:n}})},getSearchInfo:function(e){let t=rL.get(e.address);return void 0===t||t.size<1?null:{title:Array.from(t)[0],x:{tag:"unknown"}}},renderInfo:function(e){return(0,u.jsx)("p",{children:e.info.title})}}}})}},o={};function a(e){var t=o[e];if(void 0!==t)return t.exports;var n=o[e]={exports:{}};return i[e](n,n.exports,a),n.exports}a.m=i,a.d=(e,t)=>{for(var n in t)a.o(t,n)&&!a.o(e,n)&&Object.defineProperty(e,n,{enumerable:!0,get:t[n]})},a.u=e=>"static/js/async/"+e+"."+({147:"36b7cdab",968:"3958b9bf"})[e]+".js",a.g=(()=>{if("object"==typeof globalThis)return globalThis;try{return this||Function("return this")()}catch(e){if("object"==typeof window)return window}})(),a.o=(e,t)=>Object.prototype.hasOwnProperty.call(e,t),a.r=e=>{"u">typeof Symbol&&Symbol.toStringTag&&Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(e,"__esModule",{value:!0})},e=[],a.O=(t,n,r,i)=>{if(n){i=i||0;for(var o=e.length;o>0&&e[o-1][2]>i;o--)e[o]=e[o-1];e[o]=[n,r,i];return}for(var l=1/0,o=0;o<e.length;o++){for(var[n,r,i]=e[o],s=!0,c=0;c<n.length;c++)(!1&i||l>=i)&&Object.keys(a.O).every(e=>a.O[e](n[c]))?n.splice(c--,1):(s=!1,i<l&&(l=i));if(s){e.splice(o--,1);var d=r();void 0!==d&&(t=d)}}return t},a.p="/demos/DXPO/",a.b=document.baseURI||self.location.href,t={410:0},a.O.j=e=>0===t[e],n=(e,n)=>{var r,i,[o,l,s]=n,c=0;if(o.some(e=>0!==t[e])){for(r in l)a.o(l,r)&&(a.m[r]=l[r]);if(s)var d=s(a)}for(e&&e(n);c<o.length;c++)i=o[c],a.o(t,i)&&t[i]&&t[i][0](),t[i]=0;return a.O(d)},(r=self.webpackChunksvgmapviewer_example_floors=self.webpackChunksvgmapviewer_example_floors||[]).forEach(n.bind(null,0)),r.push=n.bind(null,r.push.bind(r));var l=a.O(void 0,["783","845","902"],()=>a(76));l=a.O(l)})();