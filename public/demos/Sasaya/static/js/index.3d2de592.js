...
`})]})}function tw(e){let{_p:t,_hv:n,_size:r,_leg:i}=e,o=tm(),a=null!==t&&null!==n&&tl(o)?function(e,t,n,r,i){let{open:o,animating:a}=e,{width:l,height:s}=r,c=D(i.q,-1);if(a){let[e,n]=o?[0,1]:[1,0],[r,i]=o?[0,1]:[1,0],[a,d]=o?["0px","0px"]:["var(--dp-x)","var(--dp-y)"],[u,x]=o?["var(--dp-x)","var(--dp-y)"]:["0px","0px"],h=o?eZ:eY;return`
.detail,
.balloon {
  --q-x: ${t.x}px;
  --q-y: ${t.y}px;
...
`;function tH(){return e4("detail",(0,u.jsx)(tU,{}),"ui"),(0,u.jsx)("div",{id:"detail"})}function tU(){return(0,u.jsxs)("div",{className:"ui-content detail-balloon",children:[(0,u.jsx)(tW,{}),(0,u.jsx)(tq,{})]})}function tW(){let e,t,n,r,i,o,a,l,s,c,d,x,h=tg().detail,g=(o=h.p,a=h.layout,l=function(e,t){let{x:n,y:r}=t,i=e.width/e.height,o={x:n/e.width,y:r/e.height},a=i>1?e8(o.x):te(o.x);return{h:a,v:i>1?te(o.y):e8(o.y),th:Math.atan2(e.height,e.width)}}(h.layout.container,o),s=a.container.width,t=50*(e=.01*Math.min(s,c=a.container.height)),n=50*e,r=10*e,i=t/100,x=tt(l,(d={bw:t,bh:n,lh:r,d:i,width:t+2*r+2*i,height:n+2*r+2*i}).bw,d.bh,d.lh),{_p:o,_hv:l,_W:s,_H:c,_size:d,_leg:x});return(0,u.jsxs)(u.Fragment,{children:[(0,u.jsx)(tf,{...g}),(0,u.jsx)(tz,{_detail:h}),(0,u.jsx)(tw,{...g})]})}function tq(){return(0,u.jsx)("svg",{id:"ui-svg-defs",children:(0,u.jsx)("defs",{children:(0,u.jsx)(e7,{})})})}function tZ(){return e4("footer",(0,u.jsx)(tY,{}),"ui"),(0,u.jsx)("div",{id:"footer"})}function tY(){let e=c;return(0,u.jsxs)("div",{className:"ui-content footer",children:[(0,u.jsx)("p",{children:e.copyright}),(0,u.jsxs)("style",{children:[tP,(0,u.jsx)(tV,{})]})]})}let tP=`
.footer {
  ${ek}
  ${eI}
  padding: 0.4em;
...
l-6,0
l0,-5
`;function nu(){return c.mapCoord.matrix.isIdentity?(0,u.jsx)(u.Fragment,{}):(0,u.jsx)("div",{className:"button-item position",onClick:()=>ee(tj.position),children:(0,u.jsx)("svg",{viewBox:"-5.25 -5.25 10.5 10.5",children:(0,u.jsx)("path",{d:ng})})})}let nx=3*Math.sqrt(2),nh=nx+6,ng=`
M 0,0
m 0,${nh/2}
l -3,-3
a ${nx},${nx} 0,1,1 6,0
