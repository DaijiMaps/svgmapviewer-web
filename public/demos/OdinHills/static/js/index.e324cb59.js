...
`})]})}function tw(e){let{_p:t,_hv:n,_size:r,_leg:i}=e,o=tm(),a=null!==t&&null!==n&&tl(o)?function(e,t,n,r){let{open:i,animating:o}=e,{width:a,height:l}=n,s=T(r.q,-1);if(o){let[e,n]=i?[0,1]:[1,0],[r,o]=i?[0,1]:[1,0],[c,d]=i?["0px","0px"]:["var(--dp-x)","var(--dp-y)"],[u,h]=i?["var(--dp-x)","var(--dp-y)"]:["0px","0px"],x=i?eZ:eP;return`
.detail,
.balloon {
  --q-x: ${t.x}px;
  --q-y: ${t.y}px;
...
`})}function nk(){return e4("screen",(0,u.jsx)(nD,{}),"ui"),(0,u.jsx)("div",{id:"screen"})}function nD(){let e=tR();return(0,u.jsx)("div",{ref:e,className:"ui-content screen",onClick:()=>ee(tc.close),children:(0,u.jsxs)("style",{children:[nT,(0,u.jsx)(nL,{})]})})}let nT=`
.screen {
  ${eM}
  ${eR}
