...
`}(t)},animating:!0}),target:"Animating"},"LAYOUT.DONE":{guard:e=>{let{event:t}=e;return!t.rendered},actions:(0,J.a)({shown:!1}),target:"WaitingForLayout"}}},Animating:{on:{"STYLE.ANIMATION.END":{actions:(0,J.a)({animation:null,animating:!1}),target:"Idle"}}}}}),ew=(0,K.c)(eS,{systemId:"system-viewer1"});function ej(e){ew.send(e)}function eE(e){return(0,X.d4)(ew,t=>e(t.context))}function eA(){ej({type:"STYLE.SCROLL",currentScroll:ey})}function eb(){return eE(e=>e.layout.container)}function eO(){return eE(e=>e.distanceRadius)}let eF=`
position: absolute;
left: 0;
top: 0;
`,e$=`
...
h${-t}
z
`,{p:a,q:l,a:s,b:c}=tt(e,t,n,r),d=F(l,s),u=F(c,l),h=F(a,c);return{body:o,leg:`
m${s.x},${s.y}
l${d.x},${d.y}
l${u.x},${u.y}
l${h.x},${h.y}
...
`})]})}function tS(e){let{_p:t,_hv:n,_size:r,_leg:i}=e,o=tm(),a=null!==t&&null!==n&&tl(o)?function(e,t,n,r,i){let{open:o,animating:a}=e,{width:l,height:s}=r,c=k(i.q,-1);if(a){let[e,n]=o?[0,1]:[1,0],[r,i]=o?[0,1]:[1,0],[a,d]=o?["0px","0px"]:["var(--dp-x)","var(--dp-y)"],[u,h]=o?["var(--dp-x)","var(--dp-y)"]:["0px","0px"],x=o?eZ:eY;return`
.detail,
.balloon {
  --q-x: ${t.x}px;
  --q-y: ${t.y}px;
...
`}(o,t,0,r,i):".balloon, .detail { visibility: hidden; }";return(0,u.jsx)("style",{children:a})}let tw={zoomIn:new Set,zoomOut:new Set,rotate:new Set,reset:new Set,recenter:new Set,fullscreen:new Set,position:new Set},tj=()=>ee(tw.zoomIn),tE=()=>ee(tw.zoomOut),tA=()=>ee(tw.rotate),tb=()=>ee(tw.reset),tO=()=>ee(tw.recenter),tF={multiStart:new Set,multiEnd:new Set,zoom:new Set},t$=(0,_.e)("panning");t$.subscribe(e=>{let t;return t=e,et(er.mode,t)});let tM=(0,G.mj)({types:{},guards:{isHoming:e=>{let{context:{animationReq:t}}=e;return null!==t&&"home"===t.type},isContainerRendered:()=>null!==document.querySelector(".container"),isMapRendered:()=>c.isMapRendered(),isUiRendered:()=>c.isUiRendered()},actions:{setRendered:(0,J.a)({rendered:!0}),emitGetScroll:(0,eV.a)(()=>({type:"SCROLL.GET"})),emitSyncScroll:(0,eV.a)(e=>{let{context:{layout:t}}=e;return{type:"SCROLL.SYNC",pos:t.scroll}}),emitSyncScrollSync:(0,eV.a)(e=>{let{context:{layout:t}}=e;return{type:"SCROLL.SYNCSYNC",pos:t.scroll}}),calcZoomAnimation:(0,J.a)({animation:e=>{var t,n,r,i,o,a,l,s,d,u,h,x,p;let g,m,y,f,v,S,w,j,{context:{animationReq:E,layout:A}}=e;return null===E?null:"zoom"===E.type?(t=A,n=E.z,r=E.p,g=es(t).inverse().transformPoint(r),m=1/(i=n,Math.pow(c.zoomFactor,i)),y=eo().scale(1/m,1/m),{type:"Zoom",svg:P(t.svg,m,g.x,g.y),svgScale:t.svgScale*m,q:y,o:r}):"home"===E.type?(o=A,f=C((a=function(e){let{config:t,content:n}=e;return{config:t,...el(t),content:n}}(A)).config.inner),v=es(o).transformPoint(f),S=a.svgScale/o.svgScale,j=(function(e,t){if(e instanceof DOMMatrixReadOnly)return eo(1,0,0,1,e.e,e.f);if("number"==typeof e&&"number"==typeof t)return eo(1,0,0,1,e,t);throw Error("dommatrixreadonlyTranslateOnly")})((w=C(o.container)).x-v.x,w.y-v.y).multiply((l=1/S,s=1/S,d=v.x,u=v.y,eo().scale(l,s,1,d,u,0))),{type:"Zoom",svg:a.svg,svgScale:a.svgScale,q:j,o:null}):(h=0,x=90,p=E.p,{type:"Rotate",deg:90,q:eo().rotate(90),o:p})}}),updateLayoutFromZoom:(0,J.a)({prevLayout:e=>{let{context:{layout:t}}=e;return t},layout:e=>{let{context:{layout:t,animation:n}}=e;return function(e,t){var n,r,i;return null===t?e:"Move"===t.type?(n=t.move,{...e,scroll:I(e.scroll,n)}):"Zoom"===t.type?(r=t.svg,i=t.svgScale,{...e,svg:r,svgScale:i}):ep(e,t.deg)}(t,n)}}),endZoom:(0,J.a)({prevLayout:null,animation:null,zoom:e=>{let{context:{zoom:t,animationReq:n}}=e;return t*(null===n||"zoom"!==n.type?1:Math.pow(2,n.z))},rotate:e=>{let{context:{rotate:t,animationReq:n}}=e;return t+(null===n||"rotate"!==n.type?0:n.deg)}}),endHome:(0,J.a)({cursor:e=>{let{context:{origLayout:t}}=e;return C(t.container)},layout:e=>{let{context:{origLayout:t,rotate:n}}=e;return ep(eh(t,9),n)}}),emitSyncAnimation:(0,eV.a)(e=>{let{context:{animation:t}}=e;return{type:"SYNC.ANIMATION",animation:t}}),emitZoomStart:(0,eV.a)(e=>{let{context:{layout:t,zoom:n}}=e;return{type:"ZOOM.START",layout:t,zoom:n}}),emitZoomEnd:(0,eV.a)(e=>{let{context:{layout:t,zoom:n}}=e;return{type:"ZOOM.END",layout:t,zoom:n}}),resetCursor:(0,J.a)({cursor:e=>{let{context:{layout:t}}=e;return C(t.container)}}),resizeLayout:(0,J.a)({rendered:!1,origLayout:(e,t)=>{let{layout:n}=t;return n},layout:(e,t)=>{let{layout:n}=t;return eh(n,9)}}),updateLayoutFromScroll:(0,J.a)({layout:e=>{let{context:t}=e,{scroll:n}=ey;return eg(t.layout,n)}}),emitSyncLayout:(0,eV.a)(e=>{let{context:{layout:t,rendered:n}}=e;return{type:"SYNC.LAYOUT",layout:t,force:n}}),emitSearchStart:(0,eV.a)(e=>{let{context:{layout:t,cursor:n}}=e,{scroll:r}=ey;return{type:"SEARCH.START",req:{psvg:es(eg(t,r)).inverse().transformPoint(n)}}}),emitSearchEndDone:(0,eV.a)((e,t)=>{let{context:n}=e,{res:r}=t,{scroll:i}=ey,o=eg(n.layout,i);return{type:"SEARCH.END.DONE",res:null===r?null:{...r,layout:o}}}),emitSwitch:(0,eV.a)((e,t)=>{let{fidx:n}=t;return{type:"SWITCH",fidx:n}}),emitSwitchDone:(0,eV.a)(()=>({type:"SWITCH.DONE"}))}}).createMachine({id:"viewer",initial:"WaitingForResizeRequest",context:{rendered:!1,origLayout:eu,prevLayout:null,layout:eu,cursor:C(eu.container),zoom:1,rotate:0,animationReq:null,animation:null},states:{WaitingForResizeRequest:{on:{RESIZE:{actions:{type:"resizeLayout",params:e=>{let{event:t}=e;return t}},target:"Resizing"}}},Resizing:{initial:"WaitingForMapRendered",onDone:"Idle",states:{WaitingForMapRendered:{after:{250:{target:"WaitingForMapRendered",reenter:!0}},always:{guard:(0,K.j)(["isContainerRendered","isMapRendered","isUiRendered"]),target:"Layouting"}},Layouting:{entry:"emitSyncLayout",on:{RENDERED:{actions:["setRendered","emitSyncLayout","resetCursor"],target:"Syncing"}}},Syncing:{entry:"emitSyncScrollSync",on:{"SCROLL.SYNCSYNC.DONE":{target:"Appearing"}}},Appearing:{on:{"ANIMATION.END":{target:"Done"}}},Done:{type:"final"}}},Idle:{on:{RESIZE:{actions:[{type:"resizeLayout",params:e=>{let{event:t}=e;return t}}],target:"Resizing"},SEARCH:{actions:(0,J.a)({cursor:e=>{let{event:{pos:t}}=e;return t}}),target:"Searching"},SWITCH:{actions:{type:"emitSwitch",params:e=>{let{event:t}=e;return t}},target:"Switching"},RECENTER:{target:"Recentering"},ZOOM:{actions:(0,J.a)({animationReq:e=>{let{context:{layout:t},event:{z:n,p:r}}=e;return{type:"zoom",z:n,p:r??C(t.container)}}}),target:"Zooming"},HOME:{actions:(0,J.a)({animationReq:{type:"home"}}),target:"Zooming"},ROTATE:{actions:(0,J.a)({animationReq:e=>{let{context:{layout:t}}=e;return{type:"rotate",deg:90,p:C(t.container)}}}),target:"Zooming"}}},Searching:{initial:"Starting",onDone:"Idle",states:{Starting:{always:{actions:"emitSearchStart",target:"WaitingForSearchEnd"}},WaitingForSearchEnd:{on:{"SEARCH.END":{actions:{type:"emitSearchEndDone",params:e=>{let{event:t}=e;return t}},target:"WaitingForSearchDone"}}},WaitingForSearchDone:{on:{"SEARCH.DONE":{target:"Done"}}},Done:{type:"final"}}},Switching:{initial:"Animating",onDone:"Idle",states:{Animating:{on:{"SWITCH.DONE":{actions:{type:"emitSwitchDone"},target:"Done"}}},Done:{type:"final"}}},Recentering:{initial:"Stopping",onDone:"Idle",states:{Stopping:{entry:"emitGetScroll",on:{"SCROLL.GET.DONE":{target:"Rendering"}}},Rendering:{after:{50:{target:"Layouting"}}},Layouting:{always:{actions:["updateLayoutFromScroll","emitSyncLayout","emitSyncScroll"],target:"Done"}},Done:{type:"final"}}},Zooming:{id:"Zooming",initial:"Stopping",onDone:"Idle",states:{Stopping:{entry:"emitGetScroll",on:{"SCROLL.GET.DONE":{target:"Rendering"}}},Rendering:{after:{50:{target:"Starting"}}},Starting:{always:{actions:["updateLayoutFromScroll","calcZoomAnimation","updateLayoutFromZoom","emitZoomStart","emitSyncAnimation"],target:"Ending"}},Ending:{on:{"ANIMATION.END":{actions:["endZoom","emitSyncLayout","emitSyncScroll","emitZoomEnd","emitSyncAnimation"],target:"Homing"}}},Homing:{always:[{guard:"isHoming",actions:["endHome","emitSyncLayout","emitSyncScroll"],target:"Done"},{target:"Done"}]},Done:{entry:(0,J.a)({animationReq:null}),type:"final"}}}}}),tN=(0,K.c)(tM,{systemId:"system-viewer1"});function tk(e){tN.send(e)}tN.on("SEARCH.START",e=>{let t,{req:n}=e;return t=n,et(ts.start,t)}),tN.on("SEARCH.END.DONE",e=>{let t,n,{res:r}=e;null===r?tN.send({type:"SEARCH.DONE"}):(t=r,et(ts.endDone,t),n=r.psvg,et(tc.open,n))}),tN.on("ZOOM.START",e=>{let t;return t=e,et(er.zoomStart,t)}),tN.on("ZOOM.END",e=>{let t;return t=e,et(er.zoomEnd,t)}),tN.on("SWITCH",e=>{let t,{fidx:n}=e;return t=n,et(eB.select,t)}),tN.on("SWITCH.DONE",()=>ee(eB.unlock)),tN.on("SYNC.ANIMATION",e=>{let t,{animation:n}=e,r=(null==n?void 0:n.q)??null,i=(null==n?void 0:n.o)??null;null!==r&&(t={matrix:r,origin:i},et(er.animation,t))}),tN.on("SYNC.LAYOUT",e=>{let t,{layout:n,force:r}=e;return t={layout:n,force:r},et(er.layout,t)}),tN.on("SCROLL.SYNC",e=>{let t,{pos:n}=e;return t=n,et(en.sync,t)}),tN.on("SCROLL.SYNCSYNC",e=>{let t,{pos:n}=e;return t=n,et(en.syncSync,t)}),tN.on("SCROLL.GET",()=>ee(en.get));let tT=!1,tD=!1;function tL(e){tT="locked"===e,tD="locked"===e}function tC(){let e=(0,l.useRef)(null);return(0,l.useEffect)(()=>{let t=e.current;if(t)return t.addEventListener("wheel",tR),()=>{t.removeEventListener("wheel",tR)}},[e]),e}function tR(e){let t=e.currentTarget;tD&&t instanceof HTMLDivElement&&t.scrollWidth===t.clientWidth&&t.scrollHeight===t.clientHeight&&e.preventDefault()}function tI(e){let t,{_detail:n}=e,r=tC();return(0,u.jsxs)("div",{ref:r,className:"detail",onAnimationEnd:()=>{var e;return e={type:"DETAIL.ANIMATION.END"},void tx.send(e)},children:[c.renderInfo&&(1!==(t=Object.values(n.info)).length||"string"!=typeof t[0]||""!==t[0])&&c.renderInfo({info:n.info}),(0,u.jsx)("style",{children:tz})]})}let tz=`
.detail {
  ${eF}
  width: 50vmin;
  height: 50vmin;
...
`;function tB(){let{open:e,animating:t}=tg();if(t){let[t,n]=e?[0,1]:[1,0],r=e?eZ:eY;return(0,u.jsx)(u.Fragment,{children:`
.footer {
  --duration: 300ms;
  --timing: ${r};
  --a: ${t};
...
`;return(0,u.jsxs)(u.Fragment,{children:[n,r,i]})}function tQ(){let{width:e,height:t}=eb(),{client:n}=eO(),r=`
.distance {
  ${eF}
  margin: 0.1em;
  padding: 0;
...
`})}function nl(){return(0,u.jsx)("div",{className:"button-item fullscreen",onClick:()=>ee(tw.fullscreen),children:(0,u.jsx)("svg",{viewBox:"-5.25 -5.25 10.5 10.5",children:(0,u.jsx)("path",{d:ns})})})}let ns=`
M0,0
m5,5
m-1,-1
h-8
...
l-6,0
l0,-5
`;function nu(){return c.mapCoord.matrix.isIdentity?(0,u.jsx)(u.Fragment,{}):(0,u.jsx)("div",{className:"button-item position",onClick:()=>ee(tw.position),children:(0,u.jsx)("svg",{viewBox:"-5.25 -5.25 10.5 10.5",children:(0,u.jsx)("path",{d:np})})})}let nh=3*Math.sqrt(2),nx=nh+6,np=`
M 0,0
m 0,${nx/2}
l -3,-3
a ${nh},${nh} 0,1,1 6,0
...
a ${nh/2},${nh/2} 0,1,0 0,${nh}
`.replaceAll(/([.]\d\d)\d*/g,"$1");function ng(){return(0,u.jsx)("div",{className:"button-item recenter",onClick:()=>tO(),children:(0,u.jsx)("svg",{viewBox:"-5.25 -5.25 10.5 10.5",children:(0,u.jsx)("path",{d:nm})})})}let nm=`
M0,5
V-5
M5,0
H-5
...
l 1,2
l 1,-2
`;function nv(){return(0,u.jsx)("div",{className:"button-item zoom-in",onClick:()=>tj(),children:(0,u.jsx)("svg",{viewBox:"-5.25 -5.25 10.5 10.5",children:(0,u.jsx)("path",{d:nS})})})}let nS=`
M0,0
m5,5
l-2,-2
a3,3 0,1,1 -6,-6
...
m-2.5,-2.5
v5
`;function nw(){return(0,u.jsx)("div",{className:"button-item zoom-out",onClick:()=>tE(),children:(0,u.jsx)("svg",{viewBox:"-5.25 -5.25 10.5 10.5",children:(0,u.jsx)("path",{d:nj})})})}let nj=`
M0,0
m5,5
l-2,-2
a3,3 0,1,1 -6,-6
...
m-2.5,0
h5
`;function nE(){return e6("right",(0,u.jsx)(nA,{}),"ui"),(0,u.jsx)("div",{id:"right"})}function nA(){return(0,u.jsxs)("div",{className:"ui-content right bottom",children:[(0,u.jsx)(nO,{}),(0,u.jsx)("style",{children:nb})]})}let nb=`
.right {
  ${e$}
  ${eI}
  padding: 0.4em;
...
`;function nO(){return(0,u.jsxs)("div",{className:"button",children:[(0,u.jsx)(nu,{}),(0,u.jsx)(nc,{}),(0,u.jsx)(nl,{}),(0,u.jsx)(ng,{}),(0,u.jsx)(ny,{}),(0,u.jsx)(nw,{}),(0,u.jsx)(nv,{}),(0,u.jsxs)("style",{children:[nF,(0,u.jsx)(n$,{})]})]})}let nF=`
.button {
  font-size: large;
  margin: 0;
  ${eR}
...
`})}function nM(){return e6("screen",(0,u.jsx)(nN,{}),"ui"),(0,u.jsx)("div",{id:"screen"})}function nN(){let e=tC();return(0,u.jsx)("div",{ref:e,className:"ui-content screen",onClick:()=>ee(tc.close),children:(0,u.jsxs)("style",{children:[nk,(0,u.jsx)(nT,{})]})})}let nk=`
.screen {
  ${eF}
  ${eC}
