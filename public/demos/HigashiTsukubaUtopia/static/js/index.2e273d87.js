...
h${-t}
z
`,{p:a,q:l,a:s,b:c}=tt(e,t,n,r),d=$(l,s),u=$(c,l),h=$(a,c);return{body:o,leg:`
m${s.x},${s.y}
l${d.x},${d.y}
l${u.x},${u.y}
l${h.x},${h.y}
...
`;return(0,u.jsxs)(u.Fragment,{children:[n,r,i]})}function tQ(){let{width:e,height:t}=eO(),{client:n}=eM(),r=`
.distance {
  ${e$}
  margin: 0.1em;
  padding: 0;
...
a ${nh/2},${nh/2} 0,1,0 0,${nh}
`.replaceAll(/([.]\d\d)\d*/g,"$1");function np(){return(0,u.jsx)("div",{className:"button-item recenter",onClick:()=>tM(),children:(0,u.jsx)("svg",{viewBox:"-5.25 -5.25 10.5 10.5",children:(0,u.jsx)("path",{d:nm})})})}let nm=`
M0,5
V-5
M5,0
H-5
...
m-2.5,0
h5
`;function nE(){return e4("right",(0,u.jsx)(nb,{}),"ui"),(0,u.jsx)("div",{id:"right"})}function nb(){return(0,u.jsxs)("div",{className:"ui-content right bottom",children:[(0,u.jsx)(nM,{}),(0,u.jsx)("style",{children:nO})]})}let nO=`
.right {
  ${eN}
  ${ez}
  padding: 0.4em;
...
`;function nM(){return(0,u.jsxs)("div",{className:"button",children:[(0,u.jsx)(nu,{}),(0,u.jsx)(nc,{}),(0,u.jsx)(nl,{}),(0,u.jsx)(np,{}),(0,u.jsx)(nf,{}),(0,u.jsx)(nj,{}),(0,u.jsx)(nv,{}),(0,u.jsxs)("style",{children:[n$,(0,u.jsx)(nN,{})]})]})}let n$=`
.button {
  font-size: large;
  margin: 0;
  ${eI}
...
`})}function nk(){return e4("screen",(0,u.jsx)(nT,{}),"ui"),(0,u.jsx)("div",{id:"screen"})}function nT(){let e=tA();return(0,u.jsx)("div",{ref:e,className:"ui-content screen",onClick:()=>ee(tc.close),children:(0,u.jsxs)("style",{children:[nD,(0,u.jsx)(nL,{})]})})}let nD=`
.screen {
  ${e$}
  ${eA}
