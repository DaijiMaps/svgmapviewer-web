(()=>{var e,t,n,r,i={303(e,t,n){var r={"./floor-10F.svg":"751","./floor-11F.svg":"424","./floor-3F.svg":"71","./floor-4F.svg":"514","./floor-5F.svg":"993","./floor-6F.svg":"652","./floor-7F.svg":"803","./floor-8F.svg":"286","./floor-9F.svg":"765"};function i(e){return n(o(e))}function o(e){if(!n.o(r,e)){var t=Error("Cannot find module '"+e+"'");throw t.code="MODULE_NOT_FOUND",t}return r[e]}i.keys=function(){return Object.keys(r)},i.resolve=o,e.exports=i,i.id=303},751(e,t,n){"use strict";e.exports=n.p+"static/svg/floor-10F.2b3848a3.svg"},424(e,t,n){"use strict";e.exports=n.p+"static/svg/floor-11F.f3363fd4.svg"},71(e,t,n){"use strict";e.exports=n.p+"static/svg/floor-3F.a57db4ae.svg"},514(e,t,n){"use strict";e.exports=n.p+"static/svg/floor-4F.bac9ab5e.svg"},993(e,t,n){"use strict";e.exports=n.p+"static/svg/floor-5F.ab7f6032.svg"},652(e,t,n){"use strict";e.exports=n.p+"static/svg/floor-6F.f11eba5f.svg"},803(e,t,n){"use strict";e.exports=n.p+"static/svg/floor-7F.6cd8d1a5.svg"},286(e,t,n){"use strict";e.exports=n.p+"static/svg/floor-8F.93f1465b.svg"},765(e,t,n){"use strict";e.exports=n.p+"static/svg/floor-9F.d7287fc2.svg"},76(e,t,n){"use strict";let r,i,o;var a,l=n(797);let s={type:"Feature",name:"",crs:{type:"",properties:{name:""}},features:[]};new DOMMatrixReadOnly;let c={root:"root",href:"map.svg",width:0,height:0,fontSize:16,title:"svgmapviewer",subtitle:"svgmapviewer - An (opinionated) interactive offline SVG map viewer",copyright:"@ Daiji Maps",zoomFactor:3,isContainerRendered:()=>!0,isUiRendered:()=>!0,mapData:{areas:s,internals:s,origin:s,measures:s,viewbox:s,points:s,lines:s,multilinestrings:s,multipolygons:s},mapMap:{pointMap:new Map,lineMap:new Map,multilinestringMap:new Map,multipolygonMap:new Map},mapCoord:{matrix:new DOMMatrixReadOnly},origViewBox:{x:0,y:0,width:0,height:0},renderMap:function(){return(0,l.createElement)("div")},isMapRendered:()=>!0,getMapNames:()=>[],getMapPaths:()=>[],getMapObjects:()=>[],getMapSymbols:()=>[],getMapMarkers:()=>[],mapSvgStyle:"",osmSearchEntries:[],getSearchEntries:()=>[],getSearchInfo:()=>null,renderInfo:function(e){return(0,l.createElement)("p",{},e.info.title)}};function d(e){c={...c,...e}}var u=n(617);n(58);var x=n(815),g=n(622);let h=x.Ay$.union([x.Ay$.number(),x.Ay$.string()]),p=x.Ay$.array(h),m=x.Ay$.object({ids:p}),f=g.codec(g.string(),m,{decode:(e,t)=>{try{return JSON.parse(e)}catch(n){return n instanceof g.ZodError&&t.issues.push({code:"invalid_format",format:"json",input:e,message:n.message}),g.NEVER}},encode:e=>JSON.stringify(e)}),y=x.Ay$.union([x.Ay$.number(),x.Ay$.string()]),v=x.Ay$.set(y),w=x.Ay$.object({ids:v}),j=x.Ay$.codec(m,w,{decode:e=>({ids:new Set(e.ids)}),encode:e=>({ids:Array.from(e.ids)})});x.Ay$.pipe(f,j);let S=`
.liked {
  color: orange;
}
...
l${x.x},${x.y}
z
`}}(e,n,r,i);function u(e){return`M${e},${e} ${c} M${e},${e} ${d}`}return{viewBox:s,width:a,height:l,bg:u(o),fg:u(0)}}(t,e._size);return(0,u.jsxs)("svg",{className:"balloon-svg",viewBox:z(n),width:r,height:i,children:[(0,u.jsx)("path",{className:"bg",d:a}),(0,u.jsx)("path",{className:"fg",d:o}),(0,u.jsx)("style",{children:`
path.bg {
  fill: black;
  stroke: none;
}
...
`})]})}function tw(e){let{_p:t,_hv:n,_size:r,_leg:i}=e,o=tm(),a=null!==t&&null!==n&&tl(o)?function(e,t,n,r){let{open:i,animating:o}=e,{width:a,height:l}=n,s=T(r.q,-1);if(o){let[e,n]=i?[0,1]:[1,0],[r,o]=i?[0,1]:[1,0],[c,d]=i?["0px","0px"]:["var(--dp-x)","var(--dp-y)"],[u,x]=i?["var(--dp-x)","var(--dp-y)"]:["0px","0px"],g=i?eZ:eP;return`
.detail,
.balloon {
  --q-x: ${t.x}px;
  --q-y: ${t.y}px;
...
`;function tV(){let{open:e,animating:t}=tp();if(t){let[t,n]=e?[0,1]:[1,0],r=e?eZ:eP;return(0,u.jsx)(u.Fragment,{children:`
.footer {
  --duration: 300ms;
  --timing: ${r};
  --a: ${t};
...
`;function nn(){let{open:e,animating:t}=tp();if(t){let[t,n]=e?[0,1]:[1,0],r=e?eZ:eP;return(0,u.jsx)(u.Fragment,{children:`
.header {
  --timing: ${r};
  --duration: 300ms;
  --a: ${t};
...
`;function na(){let{open:e,animating:t}=tp();if(t){let[t,n]=e?[0,1]:[1,0],r=e?eZ:eP;return(0,u.jsx)(u.Fragment,{children:`
.left {
  --timing: ${r};
  --duration: 300ms;
  --a: ${t};
...
`})}function nk(){return e4("screen",(0,u.jsx)(nD,{}),"ui"),(0,u.jsx)("div",{id:"screen"})}function nD(){let e=tR();return(0,u.jsx)("div",{ref:e,className:"ui-content screen",onClick:()=>ee(tc.close),children:(0,u.jsxs)("style",{children:[nT,(0,u.jsx)(nC,{})]})})}let nT=`
.screen {
  ${eM}
  ${eR}
...
`}):n?(0,u.jsx)(u.Fragment,{children:".screen { display: initial; opacity: 0; }"}):(0,u.jsx)(u.Fragment,{children:".screen { display: none; }"});{let[t,n]=e?[0,.3]:[.3,0],r=e?eZ:eP;return(0,u.jsx)(u.Fragment,{children:`
.screen {
  --duration: 400ms;
  --timing: ${r};
  --a: ${t};
