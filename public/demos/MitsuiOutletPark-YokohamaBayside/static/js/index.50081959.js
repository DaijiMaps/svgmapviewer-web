...
l${u.x},${u.y}
z
`}}(e,n,r,o);function h(e){return`M${e},${e} ${c} M${e},${e} ${d}`}return{viewBox:l,width:a,height:s,bg:h(i),fg:h(0)}}(t,e._size);return(0,h.jsxs)("svg",{className:"balloon-svg",viewBox:z(n),width:r,height:o,children:[(0,h.jsx)("path",{className:"bg",d:a}),(0,h.jsx)("path",{className:"fg",d:i}),(0,h.jsx)("style",{children:`
path.bg {
  fill: black;
  stroke: none;
}
...
`})]})}function tA(e){let{_p:t,_hv:n,_size:r,_leg:o}=e,i=tg(),a=null!==t&&null!==n&&ts(i)?function(e,t,n,r){let{open:o,animating:i}=e,{width:a,height:s}=n,l=M(r.q,-1);if(i){let[e,n]=o?[0,1]:[1,0],[r,i]=o?[0,1]:[1,0],[c,d]=o?["0px","0px"]:["var(--dp-x)","var(--dp-y)"],[h,u]=o?["var(--dp-x)","var(--dp-y)"]:["0px","0px"],p=o?eP:eB;return`
.detail,
.balloon {
  --q-x: ${t.x}px;
  --q-y: ${t.y}px;
...
`})}function nN(){return e4("screen",(0,h.jsx)(nb,{}),"ui"),(0,h.jsx)("div",{id:"screen"})}function nb(){let e=tD();return(0,h.jsx)("div",{ref:e,className:"ui-content screen",onClick:()=>ee(tc.close),children:(0,h.jsxs)("style",{children:[nM,(0,h.jsx)(nR,{})]})})}let nM=`
.screen {
  ${eT}
  ${eD}
