...
l${u.x},${u.y}
z
`}}(t,n,o,i);return{viewBox:s,width:a,height:l,bg:`M${r},${r}`+c+`M${r},${r}`+d,fg:"M0,0"+c+"M0,0"+d}}(e,t._size);return(0,p.jsxs)("svg",{className:"balloon-svg",viewBox:F(n),width:o,height:i,children:[(0,p.jsx)("path",{className:"bg",d:a}),(0,p.jsx)("path",{className:"fg",d:r}),(0,p.jsx)("style",{children:`
path.bg {
  fill: black;
  stroke: none;
}
...
`})]})}function ev(t){let{_p:e,_hv:n,_size:o,_leg:i}=t,r=eg(),a=null!==e&&null!==n&&el(r)?function(t,e,n,o,i){let{open:r,animating:a}=t,{width:l,height:s}=o,c=M(i.q,-1);if(a){let[t,n]=r?[0,1]:[1,0],[o,i]=r?[0,1]:[1,0],[a,d]=r?["0px","0px"]:["var(--dp-x)","var(--dp-y)"],[p,u]=r?["var(--dp-x)","var(--dp-y)"]:["0px","0px"],h=r?tZ:tq;return`
.detail,
.balloon {
  --q-x: ${e.x}px;
  --q-y: ${e.y}px;
...
`;function eP(){let{open:t,animating:e}=ex();if(e){let[e,n]=t?[0,1]:[1,0],o=t?tZ:tq;return(0,p.jsx)(p.Fragment,{children:`
.footer {
  --duration: 300ms;
  --timing: ${o};
  --a: ${e};
...
`;function nn(){let{open:t,animating:e}=ex();if(e){let[e,n]=t?[0,1]:[1,0],o=t?tZ:tq;return(0,p.jsx)(p.Fragment,{children:`
.header {
  --timing: ${o};
  --duration: 300ms;
  --a: ${e};
...
`;function na(){let{open:t,animating:e}=ex();if(e){let[e,n]=t?[0,1]:[1,0],o=t?tZ:tq;return(0,p.jsx)(p.Fragment,{children:`
.left {
  --timing: ${o};
  --duration: 300ms;
  --a: ${e};
...
`}):n?(0,p.jsx)(p.Fragment,{children:".screen { display: initial; opacity: 0; }"}):(0,p.jsx)(p.Fragment,{children:".screen { display: none; }"});{let[e,n]=t?[0,.3]:[.3,0],o=t?tZ:tq;return(0,p.jsx)(p.Fragment,{children:`
.screen {
  --duration: 400ms;
  --timing: ${o};
  --a: ${e};
